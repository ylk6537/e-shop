...
<%--			</ol>--%>
			...
			<form action="${pageContext.request.contextPath}/product/updateById?Id=${productOne.id}"
				method="post">
				<!-- 正文区域 -->
					...
					<div class="row data-type">
						...
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="productNum"
								placeholder="产品编号" value="${productOne.productNum}">
						</div>
						<div class="col-md-2 title">产品名称</div>
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="productName"
								placeholder="产品名称" value="${productOne.productName}">
						</div>
...
<%--								<fmt:formatDate value="${product.departureTime }" pattern="yyyy-MM-dd HH:mm:ss"/>--%>
						...
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="cityName"
								placeholder="出发城市" value="${productOne.cityName}">
						</div>

						<div class="col-md-2 title">产品价格</div>
						<div class="col-md-4 data">
							<input type="text" class="form-control" placeholder="产品价格"
								name="productPrice" value="${productOne.productPrice}">
						</div>
						...
						<div class="col-md-4 data">
							<select class="form-control select2" style="width: 100%"
								name="productStatus">
								<option value="0" id="gb">关闭</option>
								<option value="1" id="kq">开启</option>
							</select>
						</div>
						...
						<div class="col-md-10 data rowHeight2x">
							<textarea class="form-control" rows="3" placeholder="其他信息"
								name="productDesc" >${productOne.productDesc}</textarea>
						</div>

...
<%--			</ol>--%>
				...
				<div class="row data-type">
					...
					<div class="col-md-4 data">
						<input type="text" class="form-control" placeholder="订单编号" name="orderNum"
							   value="${infoList.orderNum}" readonly="readonly">
					</div>
					<div class="col-md-2 title">下单时间</div>
					<div class="col-md-4 data">
						<input type="text" class="form-control" placeholder="下单时间" name="orderTime"
							   value="${infoList.orderTime}" readonly="readonly">
					</div>

					<div class="col-md-2 title">商品名称</div>
					<div class="col-md-4 data">
						<input type="text" class="form-control" name="productName" placeholder="商品名称"
							value="${infoList.productName}" readonly="readonly">
					</div>
					...
					<div class="col-md-4 data">
						<input type="text" class="form-control" placeholder="出发城市" name="cityName"
							value="${infoList.cityName}" readonly="readonly">
					</div>
					...
					<div class="col-md-4 data">
						<div class="input-group date">
							...
							<input type="text" class="form-control pull-right"
								id="datepicker-a6" value="${infoList.departureTime}" name="departureTime"
								readonly="readonly">
						</div>
					</div>
					...
					<div class="col-md-4 data">
						<input type="text" class="form-control" placeholder="价格"
							value="${infoList.productPrice}" readonly="readonly" name="productPrice">
					</div>
				...
				<div class="panel panel-default">
					...
					<table id="dataList"
						...
						<tr>
							...
							<td><input type="text" size="10" name="sex" value="${0==infoList.sex?'男':'女' }" style="border:none;"
									   readonly="readonly"></td>
			...
			<div class="panel panel-default">
				...
				<div class="row data-type">
					...
					<div class="col-md-4 data text">${infoList.nickname }</div>

					<div class="col-md-2 title">联系人</div>
					<div class="col-md-4 data text">${infoList.hyname}</div>

					<div class="col-md-2 title">手机号</div>
					<div class="col-md-4 data text">${infoList.phoneNum}</div>

					<div class="col-md-2 title">邮箱</div>
					<div class="col-md-4 data text">${infoList.email}</div>
